...
FREE_DOCS = {
    ...
    "jkx": {
        "name": "🏢 ЖКХ / УК",
        "items": {
            1: {"name": "Памятка по ОДПУ (общедомовые приборы учета)", "file": "Памятка_ОДПУ_общедомовые_приборы_учета.pdf"},
    ...
    "arenda": {
        ...
        "items": {
            1: {"name": "Памятка арендатору с чек-листом", "file": "Памятка_арендатору_с_чек_листом.pdf"},
            2: {"name": "Памятка наймодателю с чек-листом", "file": "Памятка_наймодателю_с_чек_листом.pdf"},
            3: {"name": "Памятка арендодателю с чек-листом", "file": "Памятка_арендодателю_с_чек_листом.pdf"},
            4: {"name": "Памятка нанимателю с чек-листом", "file": "Памятка_нанимателю_с_чек_листом.pdf"},
            5: {"name": "Претензия досудебная", "file": "Претензия_досудебная.pdf"},
            6: {"name": "Расписка о получении денег", "file": "Расписка_о_получении_денег.pdf"},
            7: {"name": "Универсальный акт", "file": "Универсальный_акт.pdf"}
        }
    }
}
# ============================================
