#!/usr/bin/env python3
# FORCE_CACHE_REBUILD_v4_2026-04-17
"""
...
FREE_DOCS = {
    "zaliv": {
        "name": "💧 Залив",
        "items": {
            1: {"name": "Памятка: Вас затопили", "file": "Памятка_Вас_затопили.pdf"},
            2: {"name": "Памятка: Вы затопили", "file": "Памятка_Вы_затопили.pdf"},
    ...
    "jkx": {
        ...
        "items": {
            ...
            3: {"name": "Памятка по ИПУ", "file": "Памятка_по_ИПУ.pdf"}
        }
    },
    "arenda": {
        ...
        "items": {
            ...
            2: {"name": "Памятка наймодателю", "file": "Памятка_наймодателю_с_чек_листом.pdf"},
            3: {"name": "Памятка арендодателю", "file": "Памятка_арендодателю_с_чек_листом.pdf"},
            4: {"name": "Памятка нанимателю", "file": "Памятка_нанимателю_с_чек_листом.pdf"}
        }
    },
    "docs": {
        "name": "📄 Действуй уверенно. Образцы документов",
        "items": {
            1: {"name": "Расписка о получении денег", "file": "Расписка_о_получении_денег.pdf"},
            2: {"name": "Универсальный акт", "file": "Универсальный_акт.pdf"},
            3: {"name": "Претензия досудебная", "file": "Претензия_досудебная.pdf"},
            4: {"name": "Памятка по расписке", "file": "Памятка_по_расписке.pdf"},
            5: {"name": "Памятка по актам", "file": "Памятка_по_Актам_с_чек_листом.pdf"},
            6: {"name": "Памятка по аудиозаписи", "file": "Памятка_аудиозапись_и_чек_лист.pdf"},
            7: {"name": "Памятка по геолокации", "file": "Памятка_геолокация.pdf"},
            8: {"name": "Памятка по досудебной претензии", "file": "Памятка_по_претензии.pdf"}
        }
    },
    "geolocation": {
        "name": "📍 Инструкции по геолокации",
        "items": {
            1: {"name": "Для iPhone", "file": "Геолокация_фото_для_айфона.html"},
            2: {"name": "Для Android", "file": "Геолокация_фото_для_android.html"}
        }
    }
}
# ============================================
