...
FREE_DOCS = {
    ...
    "jkx": {
        "name": "🏢 ЖКХ / УК",
        "items": {
            1: {"name": "Памятка по ОДПУ", "file": "Памятка_по_ОДПУ.pdf"},
            2: {"name": "Чек-лист по ЖКХ", "file": "Чек-лист_по_ЖКХ.pdf"}
        }
    },
    "arenda": {
        "name": "🏠 Аренда/найм помещений",
        "items": {
            1: {"name": "Чек-лист", "file": "Чек-лист_наним_аренд.pdf"},
            2: {"name": "Памятка", "file": "Памятка_наним_аренд.pdf"}
        }
    },
    "docs": {
        "name": "📄 Документы",
