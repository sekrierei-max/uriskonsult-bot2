...
"arenda": {
    ...
    "items": {
        1: {"name": "Памятка арендатору", "file": "Памятка_арендату_с_чек_листом.pdf"},
    ...
    "docs": {
        ...
        "items": {
            ...
            4: {"name": "Памятка по актам", "file": "Памятка_по_Актам_с_чек_листом.pdf"},
            5: {"name": "Памятка по досудебной претензии", "file": "Памятка_по_претензии.pdf"},
            6: {"name": "Памятка по расписке", "file": "Памятка_по_расписке.pdf"},
            7: {"name": "Памятка по аудиозаписи", "file": "Памятка_аудиозапись_и_чек_лист.pdf"},
            8: {"name": "Памятка по геолокации", "file": "Памятка_геолокация.pdf"}
        }
    },
    "geolocation": {
        "name": "📍 Геолокация",
        "items": {
            1: {"name": "Инструкция для iPhone", "file": "Геолокация_фото_для_айфона.html"},
            2: {"name": "Инструкция для Android", "file": "Геолокация_фото_для_android.html"}
        }
    }
}
# ============================================
