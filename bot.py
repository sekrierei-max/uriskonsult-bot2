...
FREE_DOCS = {
    ...
    "arenda": {
        ...
        "items": {
            ...
            2: {"name": "Памятка нанимателю (арендатору)", "file": "Памятка_нанимателю_арендатору.pdf"},
            3: {"name": "Памятка нанимателю с чек-листом", "file": "Памятка_нанимателю_с_чек_листом.pdf"},
            4: {"name": "Чек-лист для аренды", "file": "Чек-лист_наним_аренд.pdf"}
        }
    },
    "docs": {
        "name": "📄 Документы",
